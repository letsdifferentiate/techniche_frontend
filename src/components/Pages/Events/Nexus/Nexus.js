...
function Nexus() {
  ...
  return (
    <>
      ...
      <div className=" text-white text-xl flex justify-center" id="content">
        <div>
          <div className='flex justify-between mt-[7vw]'>
            ...
            <div className='flex'><div className='gridular'>N</div><div className='pp_mori'>EX</div><div className='gridular'>US</div></div>
            
            </div>
            <div className='img2'><a href="#"><img src={arrow_right} /></a></div>
          </div>

          <div className='mx-auto content h-[60vh]'>
            ...
            <div className='text-parent'>
              <div className='text h-[40vh] text-lg'>
                <div ref={divRefs.div1} >
                  ...
                  <div className="text-3xl  font-extrabold mt-[1vw] flex   mb-[0.5vh]"><img src={star} className='w-6 h-6 mt-1 mr-2'/>Why Nexus?</div>
                  ...
                  <div className="text-3xl  font-extrabold mt-[1vw] flex   mb-[0.5vh]"><img src={star} className='w-6 h-6 mt-1 mr-2'/>What do participants gain?</div>
                ...
                <div ref={divRefs.div2} >
                  ...
                  <div className="text-3xl  font-extrabold mt-[2vw] flex   mb-[0.5vh]"><img src={star} className='w-6 h-6 mt-1 mr-2'/>THIS YEAR'S EVENTS LINEUP</div>
                  ...
                  <div />
                  <div className="text-3xl  font-extrabold mt-[2vw] flex   mb-[0.5vh]"><img src={star} className='w-6 h-6 mt-1 mr-2'/>NEXUS: THRIVE AND NETWORK</div>
                ...
                <div ref={divRefs.div3} >
                  <div class="flex flex-wrap justify-center mb-[20vh]">
