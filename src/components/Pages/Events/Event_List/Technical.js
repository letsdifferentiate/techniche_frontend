...
function Technical() {
  return (
    <div className='w-[70vw] mx-auto pt-10 my-20'>
        ...
        <div className='flex justify-between items-center text-3xl lg:text-7xl'>
            <div>
        ...
        <div className='flex text-white  border border-white rounded-full ' >
         <Link to="/events/technical"> <div className=' bg-blue-700  rounded-full text-sm m-2  md:px-0 lg:py-2  px-4 lg:px-8   w-20 md:w-24 lg:w-36'>Technical</div></Link>
         <Link to="/events/management"> <div className='text-sm border-x border-white m-2 md:px-0 lg:py-2 px-4 lg:px-8  w-30 md:w-34 lg:w-36'>Management</div></Link>
         ...
         <Link to="/events/pronites"> <div className=' text-sm m-2  md:px-0 lg:py-2 px-4 lg:px-8 w-20 md:w-24 lg:w-36'>Pronites</div></Link>
        </div>
        </div>
