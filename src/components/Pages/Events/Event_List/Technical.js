    ...
    <div className='w-[70vw] mx-auto pt-10 my-20'>
      ...
      <div className='flex inline-block justify-center my-10'>
        <div className='flex text-white  border border-white rounded-full' >
         <Link to="/events/technical"> <div className='border-r border-white m-2  py-1 px-8 bg-blue-700  rounded-full'>Technical</div></Link>
         <Link to="/events/management"> <div className='border-x border-white m-2  py-1 px-8'>Management</div></Link>
         <Link to="/events/initiatives"> <div className='border-r border-white m-2  py-1 px-8 '>Initiatives</div></Link>
