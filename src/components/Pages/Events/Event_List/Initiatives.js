    ...
    <div className='w-[70vw] mx-auto pt-10 my-20'>
      ...
      <div className='flex inline-block justify-center my-10'>
        <div className='flex text-white  border border-white rounded-full' >
         ...
         <Link to="/events/management"> <div className='border-r border-white m-2  py-1 px-8'>Management</div></Link>
         <Link to="/events/initiatives"> <div className='border-r border-white m-2  py-1 px-8 bg-blue-700  rounded-full'>Initiatives</div></Link>
         <Link to="/events/pronites"> <div className='border-l border-white m-2 m-2 py-1 px-8'>Pronites</div></Link>
        </div>
        </div>
