  ...
  return (
    <div className='w-[70vw] mx-auto pt-10 my-20'>
        ...
        <div className='flex text-white  border border-white rounded-full ' >
         ...
         <Link to="/events/management"> <div className='bg-blue-700  rounded-full text-sm  m-2 md:px-0 lg:py-2 px-4 lg:px-8  w-30 md:w-34 lg:w-36'>Management</div></Link>
         <Link to="/events/initiatives"> <div className=' text-sm border-x border-white m-2  md:px-0 lg:py-2 px-4 lg:px-8 w-20 md:w-24 lg:w-36'>Initiatives</div></Link>
