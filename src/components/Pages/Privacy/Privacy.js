...
function PrivacyTerms() {
  return (
    ...
    <div class="container my-15" >
        ...
        <p>Effective date: Apr 07, 2019</p>


        <p>Techniche, IIT Guwahati ("us", "we", or "our") operates the https://techniche.org website (the "Service").
        </p>

        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you
            use
            our Service and the choices you have associated with that data. Our Privacy Policy for Techniche, IIT
            Guwahati
        ...
        <p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and
            ...
            this
            Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://techniche.org
        </p>
        ...
        <p>If you wish to erase your data from Techniche, you can do so by following the instructions given in this page
            <a href="/data_deletion" className="ok" >click here</a>
        </p>
        <h5>Usage Data</h5>
        ...
        <p>Techniche, IIT Guwahati uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement
            to
            that transfer.</p>
        <p>Techniche, IIT Guwahati will take all steps reasonably necessary to ensure that your data is treated securely
            and
        ...
        <p>Techniche, IIT Guwahati may disclose your Personal Data in the good faith belief that such action is
            necessary
            to:</p>
        <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Techniche, IIT Guwahati</li>
        ...
        <ul>
            <li><a href="/cdn-cgi/l/email-protection#1b343472757d745b6f7e7873757278737e3574697c">By email: <span class="__cf_email__" data-cfemail="41282f272e01352422292f282229246f2e33266f282f">[email&#160;protected]</span></a></li>
